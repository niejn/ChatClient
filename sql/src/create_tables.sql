...
--ADDED ON DELETE CASCADE FOR CHAT_ID
...
--ADDED ON DELETE CASCADE FOR MSG_ID
CREATE TABLE NOTIFICATION(
	usr_login char(50), 
	msg_id integer,
	PRIMARY KEY(usr_login,msg_id),
	FOREIGN KEY(usr_login) REFERENCES USR(login) ON DELETE CASCADE,
	FOREIGN KEY(msg_id) REFERENCES MESSAGE(msg_id) ON DELETE CASCADE);
--ADDED ON DELETE CASCADE FOR URS_LOGIN AND MSG_ID
